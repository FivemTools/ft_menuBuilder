...
RegisterNetEvent('ft_menuBuilder:ClRemoveButton')
AddEventHandler('ft_menuBuilder:ClRemoveButton', function(name, button)
...
RegisterNetEvent('ft_menuBuilder:ClRemoveMenu')
AddEventHandler('ft_menuBuilder:ClRemoveMenur', function(name)
  RemoveMenu(name)
end)
